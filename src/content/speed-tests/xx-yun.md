...
sources:
  ...
  - label: XX云套餐购买页面截图
    publisher: XX云
    url: https://www.xx-yun.com/
    sourceType: official
    collectedAt: 2026-08-19
    supports: [三档月付价格、流量、带宽保障、流量重置、设备数量与官方解锁说明]
    mayBeOutdated: true
    notes: 用户提供的官方后台套餐截图；截图仅展示月付档，价格和服务内容可能变化，购买前应在当前套餐页复核。
---
...
Siilas记录显示XX云只能使用官方专属客户端。用户在2026年8月19日提供的官方套餐页面截图显示，当前可见的三档月付套餐如下：

| 套餐 | 月付价格 | 每月流量 | 页面所列带宽保障 |
| --- | ---: | ---: | ---: |
| 初级—月付100G | ¥9.99/月 | 100GB | 300M |
| 中级—月付300G | ¥19.90/月 | 300GB | 500M |
| 高级—月付1000G | ¥39.90/月 | 1000GB | 800M |

截图注明常规套餐在每月订单日重置流量，未使用完的流量不会累计到下个月；三档均标注BGP中转线路、不限设备、7×24小时在线客服，并宣称支持Netflix、Disney+与ChatGPT等服务。上述“解锁”属于官方套餐说明，不等同于本站或第三方在所有节点上的实测结果。

这三档的带宽标注也与Siilas记录的100GB月付300Mbps、300GB月付500Mbps和1000GB月付800Mbps相符；节点快照显示1倍倍率。截图顶部还出现年付/月付切换及“不限时套餐”栏目，但没有展示对应价格和细则，因此本文不作补写。
